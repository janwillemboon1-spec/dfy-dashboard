...
export default function AuthConfirmPage() {
  ...
  useEffect(() => {
    ...
    async function verwerkFragment() {
      ...
      console.log('[auth/confirm] raw hash:', hash);
      const params = new URLSearchParams(hash);
      const access_token = params.get('access_token');
      const refresh_token = params.get('refresh_token');
      console.log('[auth/confirm] parsed tokens present:', { access_token: !!access_token, refresh_token: !!refresh_token });

      if (!access_token || !refresh_token) {
        console.error('[auth/confirm] missing access_token or refresh_token in fragment');
      ...
      console.log('[auth/confirm] session established, redirecting to /dashboard');
